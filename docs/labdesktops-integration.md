...
```json
{
  "fabric-foundry-lab": {
    ...
    "instructionsGuardrails": "Stay within the provided subscription, workspace, and prepared assets for this session.",
    "studentRgTemplateSpecVersionId": "/subscriptions/<subId>/resourceGroups/rg-lab-infra/providers/Microsoft.Resources/templateSpecs/fabric-foundry-lab-student-resources/versions/v1"
  }
}
```
...
1. Publish [infra/labs/fabric-foundry-lab/student-resources.bicep](../infra/labs/fabric-foundry-lab/student-resources.bicep) as a Template Spec version.
...
./publish-template-spec.ps1 `
  -TemplateSpecName fabric-foundry-lab-student-resources `
  -Version v1 `
  -TemplateFile infra/labs/fabric-foundry-lab/student-resources.bicep
```
...
1. Stay inside your assigned resource group.
2. Use only the prepared Foundry and Fabric assets.
3. Do not create extra high-cost resources.
